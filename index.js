 ...
 * displaying the total number of contributions, amount donated, 
 * and number of games on the site.
...
// use reduce() to count the total number of contributions
const totalContributions = GAMES_JSON.reduce((acc, game) => acc + game.backers, 0);

// set the inner HTML using template literal and toLocaleString for formatted output
...
const totallyRaised = GAMES_JSON.reduce((acc, game) => acc + game.pledged, 0);
